...
def openMRI():
    ...
    print("mri_image shape", mri_cv.shape)
    ...
    canvas_mri.create_image(0, 0, image=mri_image, anchor="nw")
...
def openCT():
    ...
    def printcoordsCT(event):
        ...
        # print("ct_x_label", ct_x_label)
        # print("ct_y_label", ct_y_label)
